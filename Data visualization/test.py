                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(id='input-type',
                                                        ...
                                                        options=[{'label': i, 'value': i} for i in ['Yearly Airline Performance Report', 'Yearly Airline Delay Report']],
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            tree_fig = px.treemap(tree_data, path=['Reporting_Airline', 'DestState'], values='Flights', 
                                  color='Flights', hover_data=['Reporting_Airline', 'DestState', 'Flights'],
